...
public class UpdateProductController extends HttpServlet {
    ...
    private static final String ERROR = "MainController?action=Searchp&searchp=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO product = new ProductDTO(productID, productName,image, price, quantity, catagoryID, importDate, usingDate, status);
